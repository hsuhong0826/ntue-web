...
const scenarioData = {
    ...
    '2': {
        ...
        theme: '學校的一天',
        difficulty: '適中',
        story: '午餐時間到了！營養午餐阿姨推著餐車來到小美的班上。今天的主食是白飯，全班有20位同學，老師說每個人可以盛3/4碗飯。小美是今天的值日生，她想知道要準備多少碗飯才夠全班吃。',
        challenge: '請計算：20個人每人吃3/4碗飯，總共需要準備多少碗飯？',
        hint: '可以想成：1個人吃3/4碗，2個人吃多少碗？3個人呢？找到規律後，再算20個人。或是用乘法：20 × 3/4。',
        answer: '15',
        unit: '碗',
        topics: ['分數', '乘法', '分數應用'],
        suggestion: '太棒了！你理解分數的乘法應用。在生活中，我們常需要計算「部分」的總和，你已經掌握這個技巧了！',
        wrongSuggestion: '分數乘法需要多練習。試著把問題分解：先算1個人、2個人、3個人的量，找出規律後就能理解20個人需要多少了。'
    },
    '3': {
        name: '體育課跑步',
        theme: '學校的一天',
